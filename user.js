...
user_pref("browser.newtabpage.activity-stream.improvesearch.handoffToAwesomebar", false);  // 取消新标签页搜索栏中输入直接跳到地址栏
...
user_pref("extensions.ui.lastCategory", "addons://list/extension");//附加组件默认打开拓展项
...
user_pref("uc.tweak.hide-tabs-bar", true); //  Edge-Frfox tweaks
// Allows theme to use different colours for light/dark mode.
user_pref("layout.css.light-dark.enabled", true);

//功能开启
user_pref("layout.css.color-mix.enabled", true);//开启混合颜色
...
user_pref("network.captive-portal-service.enabled", false); // [FF52+] 修正需要登录才能访问网络的问题
...
user_pref("browser.link.open_newwindow.restriction", 0); // 所有通过JavaScript 打开的窗口均与browser.link.open_newwindow 的设置保持一致。
...
user_pref("security.dialog_enable_delay", 1000); // [DEFAULT: 1000]  // 安装附加组件时的等待时间
